...
export const userOrganizations = (userUID: string) => `users/${userUID}/private/organizations`;
export const userOrganizationsRef = (userUID: string) => admin.firestore().doc(`users/${userUID}/private/organizations`);
